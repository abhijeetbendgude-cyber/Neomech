...
const About = () => {
  return (
    <div className="pt-16">
      ...
      <section
        className="relative py-24 text-white bg-center bg-cover bg-no-repeat animate-[moveBg_30s_linear_infinite]"
        style={{
          backgroundImage:
            "url('https://images.pexels.com/photos/3735709/pexels-photo-3735709.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
        }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100">
              A leading provider of pharmaceutical process solutions, specializing in aseptic processing, sterile
              manufacturing, and advanced high-performance equipment for the pharmaceutical, biotechnology, and
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-col lg:flex-row items-center gap-12">
      ...
      <h5 className="text-sm font-semibold uppercase tracking-wide mb-1">About</h5>
      <h2 className="text-3xl font-bold">Neomech</h2>
        <p className="text-lg text-gray-700 mb-6">
          Neomech is a leading provider of pharmaceutical process solutions, specializing in aseptic processing,
          sterile manufacturing, and advanced high-performance equipment for the pharmaceutical, biotechnology,
          and healthcare industries.
        </p>
        <p className="text-lg text-gray-700 mb-6">
          Driven by a commitment to innovation, quality, and regulatory compliance, we deliver state-of-the-art
          technology that enhances efficiency, sterility, and adherence to global manufacturing standards,
          ensuring excellence in every step of the production process.
        </p>
      </div>
      ...
      <div className="w-full lg:w-1/2">
        <img
          src="assets/Home0.jpeg" // Replace with your image path
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                To provide cutting-edge pharmaceutical process solutions that empower our clients to manufacture
                life-saving medications with the highest standards of quality, efficiency, and safety.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-md">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-50 rounded-full mb-6">
              ...
              <p className="text-gray-700">
                To be the global leader in pharmaceutical process technology, recognized for excellence in sterile
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              At Neomech, we understand the critical need for precision, sterility, and efficiency in pharmaceutical
              manufacturing. Our expertise spans across:
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Industry-leading autoclaves, dry heat sterilizers, and hydrogen peroxide systems for uncompromised sterility assurance.",
              },
              {
                title: "Process & Utility Systems",
                description:
                  "Water for Injection (WFI), clean steam, and CIP/SIP solutions that maintain the highest purity standards.",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Comprehensive facility design, installation, validation, and regulatory support tailored to client needs.",
              },
              {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Continuous investment in R&D to develop next-generation sterile manufacturing technologies.",
              },
              {
              ...
              <div
                key={index}
                className="text-center p-6 rounded-lg bg-blue-800 hover:bg-blue-900 transition-colors duration-300"
              >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Meet the experienced professionals who lead our company to excellence.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
              ...
              {
                image:
                  'https://images.pexels.com/photos/5668772/pexels-photo-5668772.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                name: 'Sarah Johnson',
              ...
              {
                image:
                  'https://images.pexels.com/photos/5668897/pexels-photo-5668897.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
                name: 'Michael Chen',
